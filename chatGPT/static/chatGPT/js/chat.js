const query = (obj) =>
    Object.keys(obj)
        ...
        .join("&");
const url_prefix = origin + "/chatGPT";
...
const user_image = `<img src="${origin}/static/chatGPT/img/user.png" alt="User Avatar">`;
const gpt_image = `<img src="${origin}/static/chatGPT/img/gpt.png" alt="GPT Avatar">`;
...
const ask_gpt = async (message) => {
    try {
        ...
        const response = await fetch(`${url_prefix}/conversation`, {
            method: `POST`,
        ...
        while (true) {
            ...
            if (
                chunk.includes(`<form id="challenge-form" action="${url_prefix}/conversation?`)
            ) {
...
const set_conversation = async (conversation_id) => {
    history.pushState({}, null, `${url_prefix}/origin/${conversation_id}`);
...
const new_conversation = async () => {
    history.pushState({}, null, `${url_prefix}/origin/`);
